...
这是一个来自于[Github的开源项目](https://github.com/Scinawa/quantumalgorithms.org/)--因此仅有无尽的感激献给它的诸多[贡献者们](contributions-and-acknowledgements.html).这个网站已经由 CC BY-NC-SA 4.0的许可。我们一直以来也在寻求具有天赋的人们和研究者来参与贡献：你们可以在如下的[问题和改善列表](https://github.com/Scinawa/quantumalgorithms.org/issues)中找到一些有待解决和改善的问题来通过Github的仓库来改善这本书，使得更多的读者可以从最新颖的量子信息学成果中有所收获。
...
- 首先，我们希望弥合量子计算中的介绍材料和研究材料之间的差距。
- 其次，您应该能够将本书作为一本整合了最先进算法的资源。读者和学者应该可以从本书中找到最好的量子子程序的定理陈述（连同他们的引文）和运行时间，以准备好用于新的量子算法或应用。
...
在这些讲义中，我们探讨了如何利用量子计算机和量子算法进行信息处理。众所周知，量子计算可以提供相对于经典计算的计算优势，在这个基础之上，我们更多地探索这种直觉在当前计算机科学领域产生的影响。
